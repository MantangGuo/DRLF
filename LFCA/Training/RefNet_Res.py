...
class RefNet(torch.nn.Module):
    def __init__(self,opt):
        ...
        self.conv_spa_1=torch.nn.Conv2d(in_channels=opt.channelNum,out_channels=64,kernel_size=3,stride=1,padding=1,bias=True)
        ...
        self.conv_spa_9=torch.nn.Conv2d(in_channels=64,out_channels=opt.channelNum,kernel_size=3,stride=1,padding=1,bias=True)
        ...
        self.conv_ang_9=torch.nn.Conv2d(in_channels=opt.channelNum,out_channels=opt.channelNum,kernel_size=3,stride=1,padding=1,bias=True)
